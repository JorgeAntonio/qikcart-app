...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      primary: Color(0xff00C269), // Color actualizado
      surfaceTint: Color(0xff00C269),
      onPrimary: Color(0xffffffff),
      primaryContainer: Color(0xffb9fbc0),
      ...
      inversePrimary: Color(0xff00A857), // Color inverso relacionado
      primaryFixed: Color(0xffb9fbc0),
      onPrimaryFixed: Color(0xff00210e),
      primaryFixedDim: Color(0xff95da99),
      onPrimaryFixedVariant: Color(0xff004524),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(0xff004524),
      onPrimaryContainer: Color(0xffb9fbc0),
      ...
      inversePrimary: Color(0xff004524), // Color inverso relacionado
      primaryFixed: Color(0xffb9fbc0),
      onPrimaryFixed: Color(0xff00210e),
      primaryFixedDim: Color(0xff95da99),
      onPrimaryFixedVariant: Color(0xff004524),
