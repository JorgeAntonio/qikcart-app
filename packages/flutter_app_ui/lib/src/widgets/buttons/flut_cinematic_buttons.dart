...
class FlutterAppBaseButton extends StatelessWidget {
  const FlutterAppBaseButton({
    super.key,
    this.onPressed,
    this.color,
    this.text,
...
class FlutterAppPrimaryButton extends FlutterAppBaseButton {
  const FlutterAppPrimaryButton({
    super.key,
    super.onPressed,
    super.text,
    super.icon,
