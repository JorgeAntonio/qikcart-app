...
class FlutterAppTextField extends StatefulWidget {
  ...
  const FlutterAppTextField.password({
    super.key,
    this.onChanged,
    this.hintText,
    this.controller,
  ...
  @override
  State<FlutterAppTextField> createState() => _FlutterAppTextFieldState();
}

class _FlutterAppTextFieldState extends State<FlutterAppTextField> {
  ...
  Widget? getSuffixIcon() {
    ...
    if (widget.obscureText) {
      suffixIcon = ValueListenableBuilder<bool>(
        valueListenable: obscureText,
        builder: (context, value, child) => FlutterAppIconButton(
          onPressed: () => obscureText.value = !obscureText.value,
          // TODO(brprogrammer): change icon here
          iconData: value ? FlutterAppIcons.eye : FlutterAppIcons.eye,
          fontWeight: AppFontWeight.regular,
