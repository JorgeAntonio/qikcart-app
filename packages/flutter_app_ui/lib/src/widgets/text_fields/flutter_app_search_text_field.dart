...
class FlutterAppSearchTextField extends FlutterAppTextField {
  const FlutterAppSearchTextField({
  ...
  @override
  State<FlutterAppSearchTextField> createState() =>
      _FlutCinematicSearchTextFieldState();
}

class _FlutCinematicSearchTextFieldState
    extends State<FlutterAppSearchTextField> {
  ...
  Widget build(BuildContext context) {
    return FlutterAppTextField(
      onChanged: onChanged,
      hintText: widget.hintText,
      controller: controller,
      prefixIcon: FlutterAppIcons.search,
      ...
      suffixIcon: FlutterAppIconButton(
